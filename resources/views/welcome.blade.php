<x-layout>
  ...
  <div class="col-12 col-md-8">
    ...
    <div class="row align-items-start">
      <div class="col-lg-6">
        ...
        <p class="text-muted">
          Our clinic provides hands-on experience in real-world defense scenarios. Students work alongside faculty mentors to conduct risk assessments and implement security frameworks for local small businesses.
        </p>
      </div>
  ...
  <div class="row mb-2 d-flex justify-content-center" id="cyber-careers">
    <div class="col-12 col-md-8 pb-3">
      <h3 class="d-flex justify-content-center">Cybersecurity Careers</h3>
      <article class="d-flex justify-content-center">
          Explore career opportunities in the field of cybersecurity.
  ...
  <div class="row mb-2 d-flex justify-content-center" id="cyber-news">
    <div class="col-12 col-md-8 pb-3">
      <h3 class="d-flex justify-content-center">Cybersecurity in the News</h3>
      <article class="d-flex justify-content-center">
          Latest news and updates in the field of cybersecurity.
